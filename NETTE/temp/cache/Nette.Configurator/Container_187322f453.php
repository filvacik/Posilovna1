...
class Container_187322f453 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\RandoPresenter' => [1 => ['application.3']],
			'App\Presenters\HomepagePresenter' => [1 => ['application.4']],
			'App\Presenters\Error4xxPresenter' => [1 => ['application.5']],
			'App\Presenters\VacikPresenter' => [1 => ['application.6']],
			'App\Presenters\FilipPresenter' => [1 => ['application.7']],
			'App\Presenters\Filip1Presenter' => [1 => ['application.8']],
		...
		'services' => [
			...
			'application.3' => 'App\Presenters\RandoPresenter',
			'application.4' => 'App\Presenters\HomepagePresenter',
			'application.5' => 'App\Presenters\Error4xxPresenter',
			'application.6' => 'App\Presenters\VacikPresenter',
			'application.7' => 'App\Presenters\FilipPresenter',
			'application.8' => 'App\Presenters\Filip1Presenter',
	...
	public function createServiceApplication__3(): App\Presenters\RandoPresenter
	{
	...
	public function createServiceApplication__6(): App\Presenters\VacikPresenter
	{
		$service = new App\Presenters\VacikPresenter;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__7(): App\Presenters\FilipPresenter
	{
		$service = new App\Presenters\FilipPresenter;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__8(): App\Presenters\Filip1Presenter
	{
		$service = new App\Presenters\Filip1Presenter;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
